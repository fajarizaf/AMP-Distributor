...
if (!function_exists('hypermarket_header_top')):
	function hypermarket_header_top()
	{
		get_template_part('template-parts/hypermarket-header-top');
	}
endif;
...
if (!function_exists('hypermarket_site_secondary_logo')):
	function hypermarket_site_secondary_logo()
	{
		get_template_part('template-parts/hypermarket-header-secodary-logo');
	}
endif;
...
if (!function_exists('hypermarket_header_wrapper_end')):
	...
	{
		get_template_part('template-parts/hypermarket-header-filter');
	}
endif;
// ======================================================================
