 ...
 * @since 1.0.3
 */
if (!function_exists('hypermarket_is_product_template')):
    function hypermarket_is_product_template()
    {
        return is_page_template('page-templates/template-product.php') ? true : false;
    }
endif;
