...
if (!class_exists('Hypermarket')):
...

	{
...

		{
			...
			wp_enqueue_style('basictable-styles', $this->public_assets_url . 'css/basictable.css', array() , HypermarketThemeVersion);
			wp_enqueue_style('screenvalid-styles', $this->public_assets_url . 'css/screen.css', array() , HypermarketThemeVersion);
			wp_enqueue_style('styletable', $this->public_assets_url . 'css/style.css', array() , HypermarketThemeVersion);
			wp_enqueue_style('hypermarket-theme-styles', $this->public_assets_url . 'css/hypermarket.css', array() , HypermarketThemeVersion);
			wp_enqueue_script('jquery');
			wp_register_script('jquery2', 'https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js', "", HypermarketThemeVersion, true );
			...
			wp_register_script('basictable-theme-scripts', $this->public_assets_url . 'js/jquery.basictable.js',array(
				'jquery2'
			) , HypermarketThemeVersion, true);
			wp_register_script('validate-theme-scripts', $this->public_assets_url . 'js/jquery.validate.js',array(
				'jquery2'
			) , HypermarketThemeVersion, true);
			...
			wp_enqueue_script('basictable-theme-scripts');
			wp_enqueue_script('validate-theme-scripts');
