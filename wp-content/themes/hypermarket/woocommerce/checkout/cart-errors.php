...
<p><?php _e( 'Ada beberapa masalah dengan barang-barang di keranjang Anda (ditunjukkan di atas). Silakan kembali ke halaman keranjang dan selesaikan masalah ini sebelum check out.', 'woocommerce' ) ?></p>
