...
if ( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['action'] ) && $_POST['action'] == "submitclaim") {
	...
	add_post_meta($pid, 'jenis_kendaraan', $jenis_kendaraan);
...
<div class="woocommerce">
	<div class="col-md-8">
        <form method="post" class="checkout woocommerce-checkout" id="formclaim" name="front_end" action="">
        	...
        	<h3 style="margin-top: -30px;">Form Klaim Garansi</h3>
        	...
        	<div class="woocommerce-billing-fields__field-wrapper">
        		<p class="form-row col-sm-12 form-element">
        			<input type="text" class="form-control subjectclaim" name="subjectclaim" placeholder="Subject klaim*">
        		</p>
        	</div>
