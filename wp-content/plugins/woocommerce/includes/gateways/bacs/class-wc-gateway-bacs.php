...
class WC_Gateway_BACS extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'Transfer bank langsung', 'woocommerce' );
		$this->method_description = __( 'Lakukan pembayaran secara langsung melalui BACS. Lebih dikenal sebagai transfer bank / transfer langsung', 'woocommerce' );
	...
	public function generate_account_details_html() {
		...
		?>
		<tr valign="top">
			<th scope="row" class="titledesc"><?php esc_html_e( 'Akun Detail:', 'woocommerce' ); ?></th>
	...
	private function bank_details( $order_id = '' ) {
		...
		if ( ! empty( $bacs_accounts ) ) {
			...
			if ( $has_details ) {
				echo '<section class="woocommerce-bacs-bank-details"><h2 class="wc-bacs-bank-details-heading">' . esc_html__( 'Detail bank kami', 'woocommerce' ) . '</h2>' . wp_kses_post( PHP_EOL . $account_html ) . '</section>';
			}
		}
