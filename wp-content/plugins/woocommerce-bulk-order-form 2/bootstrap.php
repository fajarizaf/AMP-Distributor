...
class WooCommerce_Bulk_Order_Form {
	 ...
	 * @var string
	 */
	public $version = '3.0.2';     # Required Plugin Class Instance
	...
	public function after_plugins_loaded() {
		...
		load_plugin_textdomain( WC_BOF_TXT, false, WC_BOF_LANGUAGE_PATH );
	}
	...
	public function load_plugin_mo_files( $mofile, $domain ) {
		if ( WC_BOF_TXT === $domain ) {
			return WC_BOF_LANGUAGE_PATH . '/' . get_locale() . '.mo';
		}
	...
	protected function upgrade( $installed_version ) {
		...
		if ( $installed_version == 'versionless' ) {
			...
			$defaults = array(
				...
				'wc_bof_template_label' => array(
					'wc_bof_price_label'            => 'Price',
					'wc_bof_product_label'          => 'Product',
					'wc_bof_quantity_label'         => 'Qty',
					'wc_bof_variation_label'        => 'Variation',
					'wc_bof_single_addtocart_label' => 'Add To Cart',
					'wc_bof_cart_label'             => 'Cart',
					'wc_bof_checkout_label'         => 'Checkout',
				),
			);
