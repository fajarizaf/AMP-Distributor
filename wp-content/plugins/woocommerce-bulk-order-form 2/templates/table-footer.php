    ...
    <tfoot id="wcbulkordertotaltbl" class="wcbulkordertotaltbl">
        <?php if( ($is_variation === true  || $is_standard === true ) && ($price == 'on')) : ?>
            <tr id="wcbulkordertotals" class="wcbulkordertotals">
                <td class="wc_bof_pricetotalhead" colspan=""> <?php _e('Total : ',WC_BOF_TXT);?> </td>
        ...
        <tr id="wcbulkorderactions" class="wcbulkorderactions">
            ...
            <td>
                <button data-formid="<?php echo $formid; ?>" type="submit" class="wcbofaddtocart" id="wcbofaddtocart_<?php echo $formid; ?>"><?php echo $cart_label; ?></button>
            </td>
        </tr>
    </tfoot>
</table> 