...
class WooCommerce_Bulk_Order_Form_Admin_Settings_Options {
	...
	public function settings_fields( $fields ) {
		...
		$fields['general']['general'][] = array(
			...
			'desc'    => __( 'Select which template you want to use. More Templates Coming Soon!', WC_BOF_TXT ),
			'options' => $tpl_List,
			'default' => 'standard',
		...
		$fields['general']['general'][] = array(
			...
			'attr'       => array(
				'data-show-label' => true,
				'data-label'      => __( 'Display Product Image in Autocomplete search ?', WC_BOF_TXT ),
				'data-ulabel'     => __( 'Display Product Image in Autocomplete search ?', WC_BOF_TXT ),
				'data-separator'  => '||',
			),
		);
		...
		$fields['general']['template_label'][] = array(
			...
			'type'    => 'text',
			'default' => 'Price',
			'label'   => __( 'Title for price fields', WC_BOF_TXT ),
			'attr'    => array( 'class' => ' wcbof-settings-width-fix', ),
		);
		...
		$fields['general']['template_label'][] = array(
			...
			'type'    => 'text',
			'default' => 'Product',
			'label'   => __( 'Title for product fields', WC_BOF_TXT ),
			'attr'    => array( 'class' => ' wcbof-settings-width-fix', ),
		);
		...
		$fields['general']['template_label'][] = array(
			...
			'type'    => 'text',
			'default' => 'Qty',
			'label'   => __( 'Title for quantity fields', WC_BOF_TXT ),
			'attr'    => array( 'class' => ' wcbof-settings-width-fix', ),
		);
		...
		$fields['general']['template_label'][] = array(
			...
			'type'    => 'text',
			'default' => 'Variation',
			'label'   => __( 'Title for variation fields', WC_BOF_TXT ),
			'attr'    => array( 'class' => ' wcbof-settings-width-fix', ),
		);
		...
		$fields['general']['template_label'][] = array(
			...
			'type'    => 'text',
			'default' => 'Add To Cart',
			'label'   => __( 'Title for Single Row Add To Cart button', WC_BOF_TXT ),
			'attr'    => array( 'class' => ' wcbof-settings-width-fix', ),
		);
		...
		$fields['general']['template_label'][] = array(
			...
			'type'    => 'text',
			'default' => 'Cart',
			'label'   => __( 'Title for Cart button', WC_BOF_TXT ),
			'attr'    => array( 'class' => ' wcbof-settings-width-fix', ),
		);
		...
		$fields['general']['template_label'][] = array(
			...
			'type'       => 'text',
			'default'    => 'Checkout',
			'label'      => __( 'Title for Checkout button', WC_BOF_TXT ),
			'attr'       => array( 'class' => ' wcbof-settings-width-fix', ),
		);
		...
		$att_desc   = __( 'This open is used only when search by is set to all %s', WC_BOF_TXT );
